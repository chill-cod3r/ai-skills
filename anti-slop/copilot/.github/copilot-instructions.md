...
Generated from `anti-slop/base.md`. Do not edit this file directly.

Writing-style guardrail skill for newsletters and posts that strips AI-sounding phrasing, bans cliché transitions and buzzwords, and pushes concrete, human-sounding, specific writing. Use when drafting, rewriting, or editing copy to sound less generic and more direct.
